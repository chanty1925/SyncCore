...
public class Scheduler{
    ...
    public void ejecutarRoundrobin(ArrayList<Proceso> listaProcesos, int quantum){
        ...
        while(procesosCompletados < totalProcesos){
            ...
            if(!colaProcesos.isEmpty()){
                ...
                if(auxProceso.getTiempoRestante() > 0){
                    ...
                    listaTerminados.add(auxProceso);
                }
            }
        ...
        listaProcesos.addAll(listaTerminados);
    ...
    public void ejecutarSJF(ArrayList<Proceso> listaProceso){
        ...
        while(procesosCompletados < totalProcesos){
            ...
            if(!colaListos.isEmpty()){
                ...
                listaTerminados.add(auxProceso); //Se añade para tener un registro de quienes salen y quienes entran para evitar errores
            }
            else{
        ...
        listaProceso.addAll(listaTerminados); //Se añaden de nuevo todos los procesos q se sacaron de la listaProcesos
    }
    //=============================FIN SJF============================================
    ...
    public void ejecutarPrioridad(ArrayList<Proceso> listaProceso){
        ...
        listaProceso.addAll(listaTerminados);
    }
    //=======================FIN PRIORIDAD==========================================
